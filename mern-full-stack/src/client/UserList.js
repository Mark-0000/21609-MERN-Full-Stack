        ...
        return (
            <div className="is-fluid">
                ...
                <nav className="navbar">
                    <h1 className="navbar-item title is-1 has-text-primary">List of Hotels</h1>
                    ...
                    <Link to={'/create-user'} className="navbar-item navbar-end">
                        <button className="button is-warning" type="button">Add Hotel</button>
                    </Link>
                </nav>
                <hr />
                {/*USER LIST*/}
                ...
                <footer className="footer has-background-primary">
                    <div className="content has-text-centered">
                        <p className="has-text-white-bis"><strong>21609 Mark Christian Albinto</strong> Back-End Web Development 2020.</p>
                    </div>
                </footer>
            </div>
